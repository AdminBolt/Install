...
#
wget https://raw.githubusercontent.com/AdminBolt/Panel/$GIT_BRANCH/installers/almalinux-9.4/greeting.sh
mv greeting.sh /etc/profile.d/bolt-greeting.sh

wget https://raw.githubusercontent.com/AdminBolt/Panel/$GIT_BRANCH/installers/almalinux-9.4/repos/bolt.repo
