...
# Install OMEGA PHP
wget https://github.com/AdminBolt/Dist/raw/main/compilators/debian/php/dist/omega-php-8.2.0-ubuntu-22.04.deb
dpkg -i omega-php-8.2.0-ubuntu-22.04.deb

# Install OMEGA NGINX
wget https://github.com/AdminBolt/Dist/raw/main/compilators/debian/nginx/dist/omega-nginx-1.24.0-ubuntu-22.04.deb
