...
#
wget https://raw.githubusercontent.com/AdminBolt/Install/main/almalinux-9.4/greeting.sh
mv greeting.sh /etc/profile.d/bolt-greeting.sh

wget https://raw.githubusercontent.com/AdminBolt/Install/main/almalinux-9.4/repos/bolt.repo
...
systemctl enable mysqld
#
wget https://raw.githubusercontent.com/AdminBolt/Install/refs/heads/main/almalinux-9.5/greeting.sh
mv greeting.sh /etc/profile.d/bolt-greeting.sh
